# Generated by Django 3.0.3 on 2020-02-11 07:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.BooleanField()),
                ('creation', models.DateTimeField(auto_now_add=True)),
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profile.Album')),
            ],
        ),
        migrations.CreateModel(
            name='Experience',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('project', 'Project'), ('publication', 'Publication'), ('certificate', 'Certificate')], max_length=11)),
                ('title', models.CharField(max_length=127)),
                ('about', models.TextField(max_length=1000, null=True)),
